...
function AboutPage() {
  return (
    <div
      id="about-page"
      className="about-page h-max mb-20 p-6 max-sm:mb-10 flex flex-col items-center"
    >
      <div className="about-heading">
        <h1 className="font-bold text-4xl">About Rapid Shortner</h1>
      </div>
      <div className="about-text">
        <p className="mt-8 text-gray-800 w-[50vw] max-sm:w-80 text-xl">
        ...
        <p className="text-gray-800 w-[50vw] max-sm:w-80 text-xl">
          ...
          suggest enhancements, or even fork it for your own use on&nbsp;
          <a target="_blank" className="text-blue-600" href="https://github.com/KushagraSingh1100/Link-Shortner">
            GitHub
          </a>
          .
        </p>
        <p className=" text-gray-800 w-[50vw] max-sm:w-80 text-xl">
          ...
          <br /> ✅ Open-source & community-driven Shorten your links today and
          experience a seamless way to manage URLs! 🚀
        </p>
      </div>
    </div>
  );
